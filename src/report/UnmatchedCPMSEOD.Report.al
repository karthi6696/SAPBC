report 85003 "Unmatched CPMS EOD"
{
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "EOD Matching Status", "EOD Match Type";
        ...
        {
            RequestFilterFields = "Matching Status", "Match Type";
            ...
            begin
                if not GuiAllowed then begin
                    "EOD Staging".SetRange("Match Type", "EOD Staging"."Match Type"::None);
    ...
    rendering
    {
        ...
        {
            type = Excel;
            LayoutFile = 'UnmatchedCPMSEOD.xlsx';
        }
    }
