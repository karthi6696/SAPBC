page 85018 "CPMS with LOB Matching"
{
    ApplicationArea = All;
        ...
        area(Processing)
        {
            ...
            action("Remove Match")
            {
                ...
                begin
                    ...
                    CPMSRecords.SetRange("LOB Match Type", CPMSRecords."LOB Match Type"::Force);
                    if CPMSRecords.FindSet() then
                        repeat
                            CPMSRecords.Validate("LOB Matching Status", CPMSRecords."LOB Matching Status"::Unmatched);
                            CPMSRecords.Modify();
    ...
    begin
        rec.SetRange("LOB Matching Status");
        Rec.SetRange("LOB Matching Status", Rec."LOB Matching Status"::Matched);
        Rec.SetRange("LOB Match Type", Rec."LOB Match Type"::Force);
        CurrPage.Update();
    end;
