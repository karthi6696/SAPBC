table 85017 "CPMS Unsummarised Lines" //CPMS
{
    ...
    fields
    {
        ...
        field(59; "Journal Entry No."; Integer)
        {
        }
        ...
        field(63; "Processed Date"; Date)
        {
        }
        field(64; "Credit Entry No."; Integer)
        {
        }
        field(65; "Debit Entry No."; Integer)
        {
        }
        field(66; "Staging Entry No."; Integer)
        {
        }
    }
    ...
    trigger OnInsert()
    var
        TTS_ARAP: Record "CPMS Unsummarised Lines";
    begin
        TTS_ARAP.Reset();
        if TTS_ARAP.FindLast() then
            "Entry No." := TTS_ARAP."Entry No." + 1
        else
            "Entry No." := 1;
    end;
